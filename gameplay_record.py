    ...
    with open("gameplay.csv", mode="w", newline="") as gameplay:
        ...
        while not ky.is_pressed("l"):
            ...
            try:
                ...
                if 1 in keyboard_state or 1 in mouse_state:
                    ...
                    # elif keyboard_state[4] == 1 and looper % 10 == 0:
                    #     cv2.imwrite(
                    #         os.path.join(image_dir, image_name),
                    #         screen_capture.capture(application_name),
                    #         [cv2.IMWRITE_JPEG_QUALITY, 40],
                    #     )
                    #     gameplay_writer.writerow(
                    #         [
                    ...
                    # for letter in keyboard_state:
                    #     qwe = qwe + ','
                    #     qwe = qwe + str(letter)

                    # gameplay_writer.writerow([mouse_state[0],mouse_state[1],mouse_state[2],*keyboard_state])
                    # gameplay_writer.writerow([mouse_state[0],mouse_state[1]])
